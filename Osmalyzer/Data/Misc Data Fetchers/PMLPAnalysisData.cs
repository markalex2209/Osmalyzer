...
[UsedImplicitly]
public class PMLPAnalysisData : AnalysisData, IUndatedAnalysisData
{
    public override string Name => "PMLP";

    public override string ReportWebLink => @"https://www.pmlp.gov.lv/lv/strukturvieniba/parvaldes-nodalas";

    public override bool NeedsPreparation => true;

    protected override string DataFileIdentifier => "pmlp";
    ...
    protected override void Download()
    {
        ...
        {
            string subpageUrl = "https://www.pmlp.gov.lv/" + matches[i].Groups[1].ToString().Trim();
    ...
    protected override void DoPrepare()
    {
        ...
        do
        {
            ...
            Match contactBottomMatch = Regex.Match(content[contactMatchStart..], @"Atrašanās vieta", RegexOptions.Singleline);
